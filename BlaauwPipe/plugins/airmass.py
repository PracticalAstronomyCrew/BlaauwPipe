...
class Airmass(Plugin):
    """ Pipeline plugin that calculates the airmass for light files
        ...
        the result is appended to header under the header keyword AIRMCALC.
    """
    ...
    def __init__(self):
        ...
        self.description = """ Plugin that calculates the airmass for all light files within
                               ...
                               file under the AIRMCALC header keyword
                           """
        self.description_short = "Calculate airmass and at it to the header."
